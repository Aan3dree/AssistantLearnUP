...
class AssistentLearnData {
  ...
  final List<LearnAssistent> _learnData = [
    ...
    LearnAssistent('Assistente virtual inteligente',
        'Se trata de um sistema que acessa um banco de dados e, com grande velocidade, gera uma resposta. O que facilita e agiliza na obtenção de informações para usuários do Assistente Virtual.'),
    LearnAssistent('Assistente virtual inteligente',
        'Além disso, os Assistentes Virtuais são capazes, por meio de Inteligência Artificial, de optimizar o banco de dados ao reconhecer mais perguntas e respostas com o passar do tempo. Portanto, desde o inicio do avanço exponencial de diversas áreas da ciência da computação e por meio de sua combinação, nas ultimas décadas. Os Assistentes Virtuais vem ganhando grande espaço.'),
    ...
    LearnAssistent('Surgimento',
        'Processamento de Linguagem Natural: Permite que os usuários possam usar a linguagem natural, humana, para se comunicarem com os assistentes; Banco de Dados: Permite que a máquina armazene e recupere grandes volumes de informações; Redes de comunicação de dados: Permite que os Assistentes Virtuais estejam nas páginas a serem acessadas, com computadores pessoais, tablets e smarthphones.'),
